...
const SectionDescrition = () => {
  return (
    <div className='sectionDescription'>
      ...
      <p>But here's the secret: a healthy lifestyle is about making healthy choices a part of your daily routine. It's not a sudden impulse; it's a habit that makes life awesome! It's about eating healthy and nutritious, following a daily routine, balancing work and play, and moving our bodies every day.</p>
